  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (params.get('reset') === 'success') {
        setSuccessMsg('Password Anda berhasil diganti! Silakan masuk menggunakan password baru Anda.');
      }
    }
        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900 sm:p-8">
          ...
          <div className="text-center">
            ...
            <h2 className="text-2xl font-black text-slate-900 dark:text-white">
              {mode === 'login' ? 'Login ke Akun Anda' : mode === 'register' ? 'Buat Akun Baru' : 'Pemulihan Password'}
            </h2>
