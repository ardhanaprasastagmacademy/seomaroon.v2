...
export const INITIAL_PROMPT_TEMPLATES: PromptTemplate[] = [
  {
    ...
    version: '2.0',
    is_active: true,
    description: 'Prompt artikel otoritas komersial tunggal (Single Article B2B) dengan optimasi Search Intent Komersial, Google Discover, AI Overview (SGE), Answer Capsule, E-E-A-T, soft-selling ke brand, 2 gambar pendukung webp, dan 5 prompt visual AI Hero Image.',
    ...
    template_markdown: `# MASTER PROMPT — SINGLE COMMERCIAL AUTHORITY ARTICLE (TEMPLATE 01)
...
Tuliskan artikel lengkap sekarang dalam format Markdown 100% yang rapi dan siap dipublikasikan.`
  },
  {
    ...
    template_markdown: `# MASTER PROMPT — ULTIMATE SEO / AEO / GEO PILLAR & SEMANTIC AUTHORITY (TEMPLATE 02)
...
Tuliskan artikel lengkap sekarang dalam format Markdown yang rapi, profesional, dan siap dipublikasikan.`
  },
  {
    ...
    template_markdown: `# MASTER PROMPT — COMMERCIAL COMPARISON & BUYER'S DECISION ENGINE (TEMPLATE 03)
...
Tuliskan artikel lengkap sekarang dalam format Markdown yang rapi, transparan, dan persuasif.`
  },
  {
    ...
    template_markdown: `# MASTER PROMPT — ACTIONABLE HOW-TO & PROBLEM SOLVING GUIDE (TEMPLATE 04)
